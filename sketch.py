...
minimumCost = calculateMinumumCost(base_load_2)
print("Minimum cost for current load ", minimumCost)
popmax = 500
mutationRate = 0.05

population = Population(minimumCost, mutationRate, popmax, base_load_2)

print("Current Load: ", population.calculateCost(base_load_2))
